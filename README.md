...
# 或分步执行
python src/pipeline.py -v 0.9.159 split
python src/pipeline.py -v 0.9.159 extract
```

### 3. 翻译

将 `pz_origin/<version>/` 上传到 ParaTranz 进行翻译。
翻译完成后下载到 `trans_origin/<version>/`。
